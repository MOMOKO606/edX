# -*- coding: utf-8 -*-
"""
Created on Sat Jul  7 15:23:00 2018
...
must be a multiple of $10 and is the same for all months. 
...
while True:
    monthlyPayment += 10
    rebalance = RemaBalance2(balance, annualInterestRate, monthlyPayment, 12)
    if rebalance <= 0:
        break
