# -*- coding: utf-8 -*-
"""
Created on Mon Jul  2 15:16:36 2018
...
One easy way to do this is to begin with a test value equal to the smaller of the 
two input arguments, and iteratively reduce this test value by 1 until you either 
